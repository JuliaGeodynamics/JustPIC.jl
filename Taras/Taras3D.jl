...
function main(np)
    ...
    for it in 1:ntime
        ...
        move_particles!(particles1, xvi, ())
        # move_particles!(particles2, xvi, ())
        # move_particles!(particles3, xvi, ())
        ...
        # # total particles
        push!(np_Bi  , sum(Array(particles1.index.data)))
...
p = [count(p) for p in Array(particles1.index)]
