...
Base.@propagate_inbounds @inline function cache_args(
    args::NTuple{N1,T}, ip, I::NTuple{N2,Int64}
) where {T,N1,N2}
...
Base.@propagate_inbounds @inline function cache_particle(
    p::NTuple{N1,T}, ip, I::NTuple{N2,Int64}
) where {T,N1,N2}
    return cache_args(p, ip, I)
end

Base.@propagate_inbounds @inline function child_index(
    parent_cell::NTuple{N,Int64}, I::NTuple{N,Int64}
) where {N}
